...
drawText('Score: %s' % (score), font, windowSurface, 690, 10)
drawText('Top Score: %s' % (topScore), font, windowSurface, 550, 10)
drawText('Rest Life: %s' % (count), font, windowSurface, 28, 10)
